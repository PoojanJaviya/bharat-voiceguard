...
if __name__ == "__main__":
    ...
    sf.write("/home/poojan/projects/bharat-voiceguard/ml-pipeline/test_call.wav", audio, SAMPLE_RATE)
    print(f"Wrote test_call.wav — {len(audio)/SAMPLE_RATE:.2f} seconds")